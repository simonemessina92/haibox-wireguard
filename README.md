...
Configuration → Domain accepts an optional hostname for Public Services links and service URLs. Configure DNS or dynamic DNS separately. Add saves it immediately; when a domain is active, Remove restores links based on the VPS public IP. This only changes Web UI navigation.
